...
{
    ./run.sh -d -r ../static-pie-apps/lang/c /helloworld
}

run_server_static()
{
    ./run.sh -d -n -r ../static-pie-apps/lang/c /server
}

run_client_static()
{
    ./run.sh -d -n -r ../static-pie-apps/lang/c /client 172.44.0.2 3333
}

run_helloworld_go_static()
{
    ./run.sh -d -r ../static-pie-apps/lang/go /helloworld
}

run_server_go_static()
{
    ./run.sh -d -n -r ../static-pie-apps/lang/go /server
}

run_client_go_static()
{
    ./run.sh -d -n -r ../static-pie-apps/lang/go /client 172.44.0.2 3333
}
...
{
    ./run.sh -d -r ../static-pie-apps/lang/rust /helloworld-musl
}

run_helloworld_rust_static_gnu()
{
    ./run.sh -d -r ../static-pie-apps/lang/rust /helloworld-gnu
}

run_nginx_static()
{
    ./run.sh -d -n -r ../static-pie-apps/nginx/rootfs /nginx
}

run_redis_static()
{
    ./run.sh -d -n -r ../static-pie-apps/redis/rootfs /redis-server /redis.conf
}

run_sqlite3_static()
{
    ./run.sh -d -r ../static-pie-apps/sqlite3/rootfs /sqlite3
}

run_bc_static()
{
    ./run.sh -d -r ../static-pie-apps/bc /bc
}
...
run_gzip_static()
{
    ...
    ./run.sh -d -r ../static-pie-apps/gzip/rootfs/ /gzip /test.txt
}
...
run_bc()
{
    ./run.sh -d -r ../dynamic-apps/bc/ "$extra_args" /usr/bin/bc
}
...
run_sqlite3()
{
    ./run.sh -d -r ../dynamic-apps/sqlite3/ "$extra_args" /usr/bin/sqlite3
}
...
run_redis()
{
    ./run.sh -d -n -r ../dynamic-apps/redis/ "$extra_args" /usr/bin/redis-server /etc/redis/redis.conf
}

run_redis7()
{
    ./run.sh -d -n -r ../dynamic-apps/redis7/ "$extra_args" /usr/bin/redis-server /etc/redis/redis.conf
}
...
run_echo()
{
    ./run.sh -d -r ../dynamic-apps/echo/ "$extra_args" /bin/echo Hello
}

run_ls()
{
    ./run.sh -d -r ../dynamic-apps/ls/ "$extra_args" /bin/ls
}

run_haproxy()
{
    ./run.sh -d -n -r ../dynamic-apps/haproxy/ "$extra_args" /bin/haproxy -f /etc/haproxy/haproxy.conf
}
